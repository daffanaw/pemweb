...
<html>
  ...
  <body>
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="grid_12" style="font-size: 50px; color: white; font-family: Trebuchet MS; margin: auto; font-style: italic;">ZeTHIS</a>
    </nav>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <br><h2 style="margin: 30px 0 30px 0;">Masukan Data Mahasiswa</h2>
          <form action="form.php" method="POST">
            
            <div class="form-group">
              <label>NPM</label>
              <input type="text" class="form-control" placeholder="NPM mahasiswa" name="nrp" required="required">
            </div>
            <div class="form-group">
              <label>Nama</label>
